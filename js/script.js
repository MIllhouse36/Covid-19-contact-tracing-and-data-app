$(document).on("click", ".searches", function (event) {
    ...
    $.ajax({
        ...
        var analysis = {
            ...
            red: "Red status indicates one should avoid travel to " + displayState + ", if possible. The State of " + displayState + " is currently reporting all critical data related to COVID-19 tracking. Two critical components determining the Destination Indicator status are 'new reported cases' and 'active cases per million.' These data points show travel to " + displayState + " should be avoided, if possible. If you must travel to " + displayState +", please continue exercising safe practices as recommended by the CDC.",
